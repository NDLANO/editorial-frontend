...
const phrases = {
  ...
  welcomePage: {
    ...
    deskSubjectsDescription:
      'Distribution of where resources in your desk-subjects is in the workflow',
    languageSubjectsDescription:
      'Distribution of where resources in your language-subjects is in the workflow',
