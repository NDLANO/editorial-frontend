...
export const REMEMBER_DESK_SUBJECTS = "rememberDeskSubjects";
export const REMEMBER_LANGUAGE_SUBJECTS = "rememberLanguageSubjects";
export const FAVOURITES_SUBJECT_ID = "urn:favourites";
export const LMA_SUBJECT_ID = "urn:lmaSubjects";
export const LANGUAGE_SUBJECT_ID = "urn:languageSubjects";
export const DESK_SUBJECT_ID = "urn:deskSubjects";
// Relevances
...
export const TAXONOMY_CUSTOM_FIELD_SUBJECT_LANGUAGE_RESPONSIBLE = "subjectLanguageResponsible";
export const TAXONOMY_CUSTOM_FIELD_SUBJECT_DESK_RESPONSIBLE = "subjectDeskResponsible";
