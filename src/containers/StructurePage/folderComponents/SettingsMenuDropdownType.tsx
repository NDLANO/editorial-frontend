      ...
      <>
        <TabsRoot orientation="vertical" variant="line" translations={{ listLabel: t("taxonomy.nodeSettings") }}>
          <StyledTabsList>
            ...
            {isTaxonomyAdmin && <TabsTrigger value="deleteTopic">{t("taxonomy.deleteNode")}</TabsTrigger>}
            <TabsIndicator />
          </StyledTabsList>
          {isTaxonomyAdmin && (
      ...
      <>
        <TabsRoot orientation="vertical" variant="line" translations={{ listLabel: t("taxonomy.nodeSettings") }}>
          <StyledTabsList>
            ...
            {isTaxonomyAdmin && <TabsTrigger value="deleteSubject">{t("taxonomy.deleteNode")}</TabsTrigger>}
            <TabsIndicator />
          </StyledTabsList>
          {isTaxonomyAdmin && (
            <StyledTabsContent value="changeSubjectName">
