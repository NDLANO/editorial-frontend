...
const phrases = {
  ...
  form: {
    ...
    affiliationtSection: 'Affiliation',
    save: 'Save',
    abort: 'Abort',
    savedOk: 'Saved OK',
    ...
    filter: {
      label: 'Filter',
      description: '1 filter is required.',
      createOption: 'Create new filter',
      emptyList: 'No filters available',
      emptyFilter: 'No matching filters found',
    },
    topics: {
      label: 'Topics',
      description: '1 topic is required.',
      createOption: 'Create new topic',
