...
const phrases = {
  htmlTitles: {
    ...
    searchAgreementPage: `Søk avtaler ${titleTemplate}`,
  ...
  searchPage: {
    ...
    agreementNoHits: 'Ingen avtaler samsvarte med søket ditt på: {query}',
  ...
  footer: {
    ...
    footerManagingEditor: 'Utgåveansvarlig: ',
  },
  errorMessage: {
