...
const phrases = {
  ...
  form: {
    ...
    grepCodes: {
      ...
      description:
        "Skriv inn koder på formatet K(E/M) eller TT fulgt av eit eller fleire siffer. Eks. KE137, KM2255, TT2. Koder som ikkje eksisterer vil ikkje bli oppretta. Tekstene visast på bokmål i ed, men korrekt i artikkelvisning.",
      descriptionSubject:
        "Skriv inn koder på formatet KV fulgt av eit eller fleire siffer. Eks. KV366, KV12. Koder som ikkje eksisterer vil ikkje bli oppretta. Tekstene visast på bokmål i ed, men korrekt i artikkelvisning.",
      noHits: "Trykk enter for å leggje til koden.",
    },
    resourceTypes: {
