...
const phrases = {
  ...
  form: {
    ...
    resourceTypes: {
      ...
      emptyFilter: 'Fant ingen passende innholdstype',
      emptyList: 'Det er ingen innholdstyper i denne listen',
    },
    filter: {
      label: 'Filter',
      description: 'Obligatorisk med minst 1 filter.',
      createOption: 'Opprett nytt filter',
      emptyFilter: 'Fant ingen passende filter',
      emptyList: 'Det er ingen filter i denne listen',
    },
    topics: {
      label: 'Emnetilknytning',
      description: 'Obligatorisk med minst 1 emnetilknytning.',
      createOption: 'Opprett ny emnetilknytning',
