...
const phrases = {
  ...
  form: {
    ...
    grepCodes: {
      ...
      description:
        "Skriv inn koder på formatet K(E/M) eller TT fulgt av ett eller flere siffer. Eks. KE137, KM2255, TT2. Koder som ikke finnes vil ikke bli opprettet. Tekstene vises på bokmål i ed men korrekt i artikkelvisning.",
      descriptionSubject:
        "Skriv inn koder på formatet KV fulgt av ett eller flere siffer. Eks. KV366, KV12. Koder som ikke finnes vil ikke bli opprettet. Tekstene vises på bokmål i ed men korrekt i artikkelvisning.",
