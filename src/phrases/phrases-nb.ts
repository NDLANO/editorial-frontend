...
const phrases = {
  ...
  searchPage: {
    header: {
      ...
      'podcast-series': 'Søk etter podkast serier',
    },
    searchButton: 'Søk',
    emptyButton: 'Tøm',
    title: 'Tittel',
    ...
    'podcast-seriesNoHits': 'Ingen podkast serier samsvarte med søket ditt på: {query}',
  ...
  subNavigation: {
    ...
    audio: 'Ny lydfil',
    podcast: 'Ny podkast',
    podcastSeries: 'Ny podkast serie',
    agreement: 'Ny avtale',
    structure: 'Strukturredigering',
    searchContent: 'Søk innhold',
    searchAudio: 'Søk lyd',
    searchPodcastSeries: 'Søk podkast',
  ...
  searchForm: {
    ...
    types: {
      ...
      podcastSeriesQuery: 'Søk på podkast serier',
