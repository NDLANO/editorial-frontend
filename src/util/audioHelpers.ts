...
export const audioApiTypeToFormType = (audio: IAudioMetaInformationDTO | undefined, language: string): AudioFormikType => {
...
export const podcastSeriesTypeToFormType = (series: ISeriesDTO | undefined, language: string): PodcastSeriesFormikType => {
  return {
    ...series,
    language,
