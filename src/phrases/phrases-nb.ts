...
const phrases = {
  ...
  taxonomy: {
    ...
    deleteChildNode: 'Slett subnode',
    addSubject: 'Legg til nytt fag',
    addExistingNode: 'Flytt eksisterende node hit',
    newSubject: 'Nytt fag',
    ...
    confirmDeleteChildNode: 'Er du sikker på at du vil slette subnoden?',
    confirmDeleteNode: 'Er du sikker på at du vil slette node?',
    linkSettings: 'Link',
