...
const phrases = {
  ...
  welcomePage: {
    ...
    deskSubjects: "Desk-subjects",
    languageSubjects: "Language-subjects",
    favoriteSubjects: "Favorite subjects",
    lmaSubjectsHeading: "Production flow in LMA-subjects",
    deskSubjectsHeading: "Production flow in desk-subjects",
    languageSubjectsHeading: "Production flow in language-subjects",
    ...
    deskSubjectsDescription: "Distribution of where resources in your desk-subjects is in the workflow",
    languageSubjectsDescription: "Distribution of where resources in your language-subjects is in the workflow",
  ...
  searchForm: {
    ...
    languageSubjects: "My language-subjects",
    deskSubjects: "My desk-subjects",
  ...
  taxonomy: {
    ...
    showDeskSubject: "Show desk-subjects",
    showLanguageSubject: "Show language-subjects",
    swapTopicArticle: {
    ...
    metadata: {
      customFields: {
        ...
        subjectLanguageResponsible: "Language responsible for the subject",
        subjectDeskResponsible: "Desk responsible for the subject",
      },
      placeholders: {
        ...
        languageResponsible: "Choose language responsible",
        deskResponsible: "Choose desk responsible",
      },
    },
  },
  notions: {
