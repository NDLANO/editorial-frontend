...
const phrases = {
  ...
  welcomePage: {
    ...
    subjectView: {
      ...
      heart: "Favorite",
      heartDescription: "Amount of favorited resources",
      flow: "In flow",
      flowDescription: "Amount of resources in flow",
      old: "Outdated",
      oldDescription: "Amount of resources that have not been revised in over 5 years",
      revision: "Revision",
      revisionDescription: "Amount of resourcecs with revision mark",
      published: "Published",
      publishedDescription: "Amount of published resources",
    },
    welcomeBack: "Welcome",
  },
  searchPage: {
