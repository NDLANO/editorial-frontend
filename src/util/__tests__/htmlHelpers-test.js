...
test('util/isNDLAFrontendUrl', () => {
  ...
  expect(isNDLAFrontendUrl('https://test.ndla.no/subjects/subject:6/topic:1:182849/topic:1:175043/resource:1:175253?filters=urn:filter:01c27030-e8f8-4a7c-a5b3-489fdb8fea30')).toBeTruthy();
