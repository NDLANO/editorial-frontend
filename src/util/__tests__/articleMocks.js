...
export const transformedArticle = {
  ...
  supportedLanguages: ['nb', 'nn', 'en'],
  tags: [],
  title: 'Bildekomposisjon og kamerabevegelser',
  updated: '2019-05-15T08:45:46Z',
  updatedBy: 'test',
  visualElement: {},
};
