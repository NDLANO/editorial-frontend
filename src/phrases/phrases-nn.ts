...
const phrases = {
  ...
  taxonomy: {
    ...
    addExistingNode: 'Flytt eksisterande node hit',
    newSubject: 'Nytt fag',
    resources: 'Ressurser',
    ...
    confirmDeleteNode: 'Er du sikker på at du vil slette noden?',
    linkSettings: 'Link',
    ...
    info: {
      ...
      missingArticleType:
        'Artikkelen med ID {{id}} mangler artikkeltype. Han er sannsynlegvis sletta.',
