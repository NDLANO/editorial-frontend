...
test('taxonomy/spliceChangedItems no changes', () => {
  // No changes
  ...
  expect(spliceChangedItems([...createItem], [...filtersMock])).toEqual([
    [],
    [
      {
        connectionId:
  ...
  expect(
    spliceChangedItems(updateFilter, filtersMock, 'id', 'id', 'relevanceId'),
  ).toEqual([
    [],
    [
      {
