...
const phrases = {
  ...
  form: {
    ...
    status: {
      ...
      proposal: 'Utkast',
      changed: {
        DRAFT: 'Artikkel lagret som kladd',
        PROPOSAL: 'Satt til utkast',
        USER_TEST: 'Satt til brukertest',
        AWAITING_QUALITY_ASSURANCE: 'Satt til kvalitetsikring.',
        QUALITY_ASSURED: 'Satt til kvalitetsikret.',
        QUEUED_FOR_PUBLISHING: 'Artikkelen ble satt til publisering.',
        PUBLISHED: 'Artikkelen ble publisert',
        AWAITING_UNPUBLISHING: 'Artikkel avpublisert.',
        UNPUBLISHED: 'Artikkel avpublisert.',
