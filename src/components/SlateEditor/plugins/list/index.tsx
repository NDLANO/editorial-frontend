...
import { TYPE_CONCEPT_INLINE, TYPE_GLOSS_INLINE } from "../concept/inline/types";
...
const inlines = [TYPE_CONCEPT_INLINE, TYPE_GLOSS_INLINE, TYPE_FOOTNOTE, TYPE_LINK, TYPE_CONTENT_LINK, TYPE_MATHML];
