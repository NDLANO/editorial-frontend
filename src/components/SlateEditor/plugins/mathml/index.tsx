...
import { createHtmlTag, reduceElementDataAttributesV2 } from "../../../../util/embedTagHelpers";
...
export const mathmlSerializer: SlateSerializer = {
  deserialize(el: HTMLElement) {
    ...
    return slatejsx(
      ...
      {
        type: TYPE_MATHML,
        data: { ...reduceElementDataAttributesV2(Array.from(el.attributes)), innerHTML: el.innerHTML },
      },
      [{ text: el.textContent }],
    );
  },
