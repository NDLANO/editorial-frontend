...
const phrases = {
  ...
  taxonomy: {
    ...
    fullTopic: "Entire topic:",
    qualityDescriptionTopic: "Quality evaluation of the topic article",
    qualityDescription: "Average quality evaluation of all resources within the topic",
