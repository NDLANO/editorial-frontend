  ...
  form: {
    ...
    status: {
      ...
      actions: {
        ...
        USER_TEST: 'Set to user test',
        AWAITING_QUALITY_ASSURANCE: 'Quality assure',
        QUALITY_ASSURED: 'Quality assure (Admin)',
        QUEUED_FOR_PUBLISHING: 'Publish',
        PUBLISHED: 'Publish (Admin)',
        AWAITING_UNPUBLISHING: 'Unpublish',
        UNPUBLISHED: 'Unpublish (Admin)',
        ARCHIEVED: 'Archive',
      },
    },
    validDate: {
