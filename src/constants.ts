...
export const STORED_SORT_OPTION_SUBJECT_VIEW_FAVORITES = "STORED_SORT_OPTION_SUBJECT_VIEW_FAVORITES";
export const STORED_SORT_OPTION_SUBJECT_VIEW_LMA = "STORED_SORT_OPTION_SUBJECT_VIEW_LMA";
export const STORED_SORT_OPTION_SUBJECT_VIEW_DA = "STORED_SORT_OPTION_SUBJECT_VIEW_DA";
export const STORED_SORT_OPTION_SUBJECT_VIEW_SA = "STORED_SORT_OPTION_SUBJECT_VIEW_SA";
