...
describe("combined table plugin tests", () => {
  test("id in th and td is preserved on serialize and normalize", () => {
    const html =
      '<section><table><tbody><tr><th data-align="right" scope="row" id="r0"><p>1</p></th><td data-align="right" id="abc"><p>2</p></td></tr></tbody></table></section>';
  ...
  test("Make sure cells in first row is marked as header", () => {
    ...
    const expected =
      '<section><table><thead><tr><th data-align="right" scope="col"><p>1</p></th></tr></thead><tbody><tr><td data-align="right"><p>2</p></td></tr></tbody></table></section>';
