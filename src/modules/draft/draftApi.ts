...
export const updateDraft = async (id: number, draft: IUpdatedArticleDTO, versionHash = "default"): Promise<IArticleDTO> =>
...
export const fetchGrepCodes = async (query: string): Promise<IGrepCodesSearchResultDTO> =>
  fetchAuthorized(`${baseUrl}/grep-codes/?query=${query}`).then((r) =>
    resolveJsonOrRejectWithError<IGrepCodesSearchResultDTO>(r),
  );
