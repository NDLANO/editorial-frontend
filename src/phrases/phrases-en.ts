...
const phrases = {
  ...
  welcomePage: {
    ...
    subjectView: {
      ...
      heart: "Hearts",
      heartDescription: "Count of favorited resources",
      flow: "In flow",
      flowDescription: "Count of resources in flow",
      old: "Outdated",
      oldDescription: "Count of resources that have not been revised in over 5 years",
      revision: "Revisions",
      revisionDescription: "Count of resourcecs with expired revision date",
      published: "Published",
      publishedDescription: "Count of published resources",
    },
    welcomeBack: "Welcome",
  },
  searchPage: {
