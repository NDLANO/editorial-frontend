...
describe('Search images', () => {
  ...
  it('Can use language dropdown', () => {
    cy.apiroute(
      'GET',
      '/image-api/v3/images/?exclude-revision-log=false&fallback=false&filter-inactive=true&include-other-statuses=false&language=en&page=1&page-size=10&sort=-relevance*',
      'searchImagesLang',
    );
