...
const phrases = {
  ...
  taxonomy: {
    ...
    resource: {
      ...
      copyError:
        'Det oppsto en feil ved kopiering av ressurser. Dobbeltsjekk de kopierte ressurser og prøv å fikse mangler manuelt eller slett de kopierte ressurser og prøv å kopiere på nytt',
    },
