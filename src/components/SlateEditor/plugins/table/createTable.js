...
export default function createTable(columns, rows, textGetter) {
    const tableBody = [createTableHeaderSection(columns, rows, textGetter ? textGetter.bind(null, 0) : null), createTableBody(columns, rows, textGetter ? textGetter.bind(null, 1) : null),]
    const align = {};
