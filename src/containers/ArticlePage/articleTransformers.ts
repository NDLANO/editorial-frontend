...
const draftApiTypeToArticleFormType = (
  ...
  return {
    ...
    id: article?.id,
    introduction: inlineContentToEditorValue(article?.introduction?.introduction ?? "", createNoop, true),
    language,
    ...
    title: inlineContentToEditorValue(article?.title?.title ?? "", createNoop, true),
