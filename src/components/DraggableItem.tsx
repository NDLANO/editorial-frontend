...
import { ComponentProps, ReactElement, ReactNode, type RefObject, cloneElement } from "react";
...
export const DragHandle = ({ children, id, tabIndex = 0, variant = "clear", ref, ...rest }: DragHandleProps) => {
  return (
