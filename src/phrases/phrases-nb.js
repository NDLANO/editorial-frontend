...
const phrases = {
  ...
  form: {
    ...
    saved: 'Lagret ',
    preview: 'Forhåndsvis',
    previewAndCompare: 'Sammenlign utkast og artikkel',
    abort: 'Avbryt',
    validate: 'Valider',
    publish: 'Publiser',
    savedOk: 'Lagret OK',
    ...
    status: {
      ...
      actions: {
        ...
        USER_TEST: 'Sett til brukertest',
        AWAITING_QUALITY_ASSURANCE: 'Kvalitetsikre',
        QUALITY_ASSURED: 'Kvalitetsikre (Admin)',
        QUEUED_FOR_PUBLISHING: 'Publiser',
        PUBLISHED: 'Publiser (Admin)',
        AWAITING_UNPUBLISHING: 'Avpubliser',
        UNPUBLISHED: 'Avpubliser (Admin)',
        ARCHIEVED: 'Arkiver',
      },
    },
    validDate: {
