...
test('adds and removes grid', async ({ page }) => {
    ...
    expect(await page.locator("[data-cy='slate-block-picker-menu']").getByRole('button').count()).toEqual(6);
